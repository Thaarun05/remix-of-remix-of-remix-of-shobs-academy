...
const StudentLogin = () => {
  ...
  if (authLoading) {
    return <div className="min-h-screen flex items-center justify-center auth-page-student">
        ...
        <div className="auth-card auth-card-student animate-auth-fade-in">
          ...
          <form onSubmit={handleSignIn} className="auth-form">
            <div className="auth-field">
              ...
              <Input type="email" placeholder="student@example.com" value={email} onChange={e => setEmail(e.target.value)} className={`auth-input auth-input-student ${errors.email ? "auth-input-error" : ""}`} required />
