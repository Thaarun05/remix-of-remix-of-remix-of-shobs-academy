    ...
    <div className="min-h-screen page">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <Card className="glass-card">
            <CardContent className="pt-6">
              <div className="h-14 w-14 rounded-2xl bg-teacher/10 border border-teacher/20 flex items-center justify-center mb-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="glass-card border-student/30">
              <CardContent className="pt-6">
                <div className="h-14 w-14 rounded-2xl bg-student/10 border border-student/20 flex items-center justify-center mb-4">
            ...
            <Card className="glass-card border-teacher/30">
              <CardContent className="pt-6">
                <div className="h-14 w-14 rounded-2xl bg-teacher/10 border border-teacher/20 flex items-center justify-center mb-4">
